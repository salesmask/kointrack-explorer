                ...
                <div className="col-11 d-block  mx-auto px-0">
                    ...
                    <div className="price-estimates-layout ">
                        ...
                        <p className="price_paragraph">
                            ...
                            estimates for next 6 months and see what other’s are
                            thinking about it. Data displayed are based on user
                            input compiled by CoinMarketCap. The cut-off for
                            estimates for each month-end is on the 21st of each
                            month.
                        </p>
                    </div>
                    ...
                    <div className=" container-fluid d-flex gx-3 gap-5 px-0 mx-0 flex-wrap ">
                        <div class=" col-11 col-xl col-md-5  border ">
                        ...
                        <div class="col-11 col-xl col-md-5 border  estimate d-flex align-items-center ">
                            <div class="card-body ">
                                <a
                                    href="#"
