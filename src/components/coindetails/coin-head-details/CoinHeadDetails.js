                            ...
                            <div className="col-12 col-md-5 col-lg-4 col-xl-3 px-0">
                                <div className="coin-head__name--wrapper d-flex justify-content-between align-items-start align-items-sm-center flex-column flex-sm-row flex-md-column align-items-md-start">
                                    <div className="d-flex justify-content-start align-items-center mb-3">
                                        <div className="image__wrapper pe-2 pe-sm-3">
                                            <img
                                                src={CoinImage}
                                                alt="coin"
                                            />
                                        </div>
                                        <div className="name pe-2 pe-sm-3">
                                            Bitcoin
                                        </div>
                                        <div className="symbol pe-2 pe-sm-3">
                                            BTC
                                        </div>
                            ...
                            <div className="col-12 col-md-6 col-lg-6 col-xl-8 px-0">
                                <div className="row mx-0 d-flex justify-content-between align-items-center flex-column-reverse flex-xl-row gap-4">
                                    <div className="col-12 col-xl-5 px-0">
                                        {/* Range bar section */}
                                        <div className="coin-head__range--wrapper d-flex justify-content-xl-start align-items-center justify-content-md-end">
                                            ...
                                            <div className="range-of__time rounded-pill d-flex justify-content-between align-items-center ms-4 px-3 py-1">
                                                <div className="pe-1 pe-sm-3 time">
                                                    24h
                                                </div>
                                                <img
                                                    src={RangeofTimeIcon}
