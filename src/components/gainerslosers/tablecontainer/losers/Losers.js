...
import Royal from '../../../../assets/gainers-losers/RoyalPay.svg';
import Decrease_Arrow from '../../../../assets/table/Decrease_Arrow.svg';

const Losers = () => {
    return (
        <>
            <div className="losers__outer--wrapper">
                <h3 className="ms-3 mb-3">Losers</h3>
                <div className="losers__table--wrapper">
